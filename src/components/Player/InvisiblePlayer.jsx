...
import ReactPlayer from 'react-player'; // ✅ Standard import fixes Vite Rollup build errors
...
const InvisiblePlayer = () => {
  ...
  // Listen for user join event to auto-unmute
  useEffect(() => {
  ...
  // Clean and extract YouTube Video ID safely
